...
import com.thrifthunter.activity.categoryJeans.paging.JeansProductRepository
...
class JeansCategoryViewModel(private val mpreference: UserPreference, repo: JeansProductRepository) :
    ViewModel() {
